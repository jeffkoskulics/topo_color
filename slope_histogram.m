...
wind_speed = 4;
scr = (0.003+1.92*10^-3*wind_speed)^(1/2); %crosswind slope standard deviation
sup = (0.000+3.16*10^-3*wind_speed)^(1/2); %upwind slope standard deviation
c21 = 0.01 - 0.86*10^-2*wind_speed;
c03 = 0.04-3.3*10^-2*wind_speed;
c40 = 0.40;
c22 = 0.12;
c04 = 0.23;
y = -x_slopes / sup;
...
p = zeros(num_x_bins-1,num_y_bins-1);
